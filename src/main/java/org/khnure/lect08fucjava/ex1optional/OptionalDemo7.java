package org.khnure.lect08fucjava.ex1optional;
...
public class OptionalDemo7 {
    public static void main(String[] args) {
        ...
        List<String> strings = Stream.of("Hello", "", "World").collect(Collectors.toList());

        // Використання Optional для обробки потенційних null значень
        strings.stream()
                .map(s -> Optional.ofNullable(s))
                .forEach(o -> o.ifPresentOrElse(System.out::println, () -> System.out.println("Null value")));

//        strings.stream().filter(e-> strings.isEmpty()).
    }
}
